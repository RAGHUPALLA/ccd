...
$con = mysqli_connect('localhost', 'root', '','ccd_db');
...
$sql = "INSERT INTO `contact_table` (`Id`, `txtName`, `txtEmail`, `txtPhone`, `txtSubject`, `txtMessage`) VALUES ('0', '$txtName', '$txtEmail', '$txtPhone','$txtSubject', '$txtMessage')";
        ...
        <div class="form-section content-width">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form class="contact-form" method="POST" name='contactform' action="contact.php">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input class="btn-primary" name="user_details" type="submit" value="Submit" />
                            </div>
                        </div>
                    </form>
                </div>
